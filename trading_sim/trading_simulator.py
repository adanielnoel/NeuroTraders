...
from trading_sim.trader import PredictiveTrader, ClassicalTrader, HybridTrader, PredictiveTraderWithoutErrorPrediction
...
if __name__ == "__main__":
    td = TradingSimulator((ClassicalTrader(),
                           PredictiveTraderWithoutErrorPrediction(),
                           PredictiveTrader(),
                           HybridTrader()))
    td.run()
